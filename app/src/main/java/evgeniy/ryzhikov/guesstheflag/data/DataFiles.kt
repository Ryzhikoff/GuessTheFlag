...
class DataFiles() {
    ...
    private val historyFlag = mapOf(
        "afganistan_1" to R.string.afghanistan,
        "afganistan_2" to R.string.afghanistan,
        "afganistan_3" to R.string.afghanistan,
        "afganistan_4" to R.string.afghanistan,
        "argentina" to R.string.argentina,
        "armenia" to R.string.armenia,
        "austria_hungary" to R.string.austria_hungary,
        "azerbaijan" to R.string.azerbaijan,
        "belarus" to R.string.belarus,
        "brazilii_1" to R.string.brazil,
        "brazilii_2" to R.string.brazil,
        "canada_1" to R.string.canada,
        "canada_2" to R.string.canada,
        "china_1" to R.string.china,
        "china_2" to R.string.china,
        "china_3" to R.string.china,
        "colombia" to R.string.colombia,
        "croatia_1" to R.string.croatia,
        "egypyt_1" to R.string.egypt,
        "egypyt_2" to R.string.egypt,
        "england_1" to R.string.england,
        "england_2" to R.string.england,
        "france_1" to R.string.france,
        "france_2" to R.string.france,
        "france_3" to R.string.france,
        "georgea" to R.string.georgia,
        "germany_1" to R.string.germany,
        "germany_2" to R.string.germany,
        "holy_roman_empire" to R.string.holy_roman_empire,
        "hungary" to R.string.hungary,
        "india" to R.string.india,
        "iran_1" to R.string.iran,
        "iran_2" to R.string.iran,
        "iran_3" to R.string.iran,
        "Iraq_1" to R.string.iraq,
        "Iraq_2" to R.string.iraq,
        "italy_1" to R.string.italy,
        "japan" to R.string.japan,
        "kampuchea" to R.string.kampuchea,
        "kazakhstan_union" to R.string.kazakhstan,
        "kazakh_khanate" to R.string.kazakh_khanate,
        "korea_1" to R.string.korea,
        "laos" to R.string.laos,
        "macedonia" to R.string.macedonia,
        "macedon_empire" to R.string.macedon_empire,
        "mexico_1" to R.string.mexico,
        "mexico_2" to R.string.mexico,
        "moldova_1" to R.string.moldova,
        "moldova_2" to R.string.moldova,
        "mongolia_1" to R.string.mongolia,
        "mongolia_2" to R.string.mongolia,
        "mongolia_3" to R.string.mongolia,
        "montenegro" to R.string.montenegro,
        "netherlands" to R.string.netherlands,
        "north_yemen" to R.string.yemen,
        "poland_1" to R.string.poland,
        "poland_2" to R.string.poland,
        "portugal" to R.string.portugal,
        "rhodesia" to R.string.rhodesia,
        "russia_1" to R.string.russia,
        "san_marino_1" to R.string.san_marino,
        "san_marino_2" to R.string.san_marino,
        "saudi_arabia_1" to R.string.saudi_arabia,
        "saudi_arabia_2" to R.string.saudi_arabia,
        "slovenii" to R.string.slovenia,
        "south_yemen" to R.string.yemen,
        "spain_1" to R.string.spain,
        "spain_2" to R.string.spain,
        "swedish_union" to R.string.sweden,
        "switzerland" to R.string.switzerland,
        "syria_1" to R.string.syria,
        "syria_2" to R.string.syria,
        "tadzhikistana_1" to R.string.tajikistan,
        "tadzhikistana_2" to R.string.tajikistan,
        "tadzhikistana_3" to R.string.tajikistan,
        "thailand" to R.string.thailand,
        "turkiye_" to R.string.turkey,
        "turkiye_2" to R.string.turkey,
        "ukrain" to R.string.ukraine,
        "usa" to R.string.united_states,
        "ussr" to R.string.ussr,
        "uzbekistan" to R.string.uzbekistan,
        "wietnam" to R.string.vietnam,
        "yugoslavia" to R.string.yugoslavia,
        "zair" to R.string.zair,
